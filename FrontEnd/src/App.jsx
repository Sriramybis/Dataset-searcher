          ...
          <tbody>
            {results.map((result, index) => (
              <tr key={index} className="border-b border-white/20">
                <td className="py-2 px-4 text-white">{result["Dataset Category"]}</td>
                <td className="py-2 px-4 text-white">{result["Vendor"]}</td>
                <td className="py-2 px-4 text-white">{result["Dataset Name"]}</td>
                <td className="py-2 px-4 text-white">{result["Description"]}</td>
                <td className="py-2 px-4 text-white">{result["Therapeutic coverage"]}</td>
                <td className="py-2 px-4 text-white">{result["Geographic coverage"]}</td>
              </tr>
            ))}
          </tbody>
        </table>
